package com.example.kaimera.gallery.ui
...
import com.example.kaimera.core.ui.components.ZoomableImageView
import com.example.kaimera.core.ui.components.ZoomableVideoLayout
    ...
    private fun saveFrameAsImage(bitmap: android.graphics.Bitmap) {
        try {
            ...
            val fileName = if (namingPattern == "sequential") {
                StorageManager.generateSequentialFileName(outputDirectory, customPrefix ?: "FRAME", extension)
            } else {
                StorageManager.generateFileName(namingPattern ?: "timestamp", customPrefix ?: "FRAME", extension)
            }
