...
import com.example.kaimera.camera.managers.IntervalometerManager
import com.example.kaimera.camera.managers.BurstModeManager
import com.example.kaimera.core.managers.PreferencesManager
import com.example.kaimera.camera.managers.ChronometerManager
import com.example.kaimera.camera.managers.VideoRecordingManager
import com.example.kaimera.camera.managers.StorageManager
import com.example.kaimera.camera.managers.CameraManager
import com.example.kaimera.core.managers.PermissionManager
import com.example.kaimera.camera.managers.OrientationManager
import com.example.kaimera.camera.managers.LocationManager
import com.example.kaimera.gallery.ui.GalleryActivity
import com.example.kaimera.LauncherActivity
import com.example.kaimera.gallery.adapters.FilterAdapter
...
import com.example.kaimera.camera.ui.components.GridOverlayView
...
class MainActivity : AppCompatActivity(), IntervalometerManager.Callback, BurstModeManager.Callback, ChronometerManager.Callback, VideoRecordingManager.Callback {
    ...
    private fun performCapture(imageCapture: ImageCapture, location: android.location.Location?) {
        ...
        val fileExtension = ImageCaptureHelper.getFileExtension(imageFormat)
