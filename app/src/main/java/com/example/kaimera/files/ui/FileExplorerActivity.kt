package com.example.kaimera.files.ui

import com.example.kaimera.R
import com.example.kaimera.core.utils.FileUtils
import com.example.kaimera.files.adapters.FileExplorerAdapter
import com.example.kaimera.LauncherActivity
import com.example.kaimera.gallery.ui.MediaViewerActivity
...
class FileExplorerActivity : AppCompatActivity() {
    ...
    private fun isVideoFile(file: File): Boolean {
        return FileUtils.isVideoFile(file)
    }
